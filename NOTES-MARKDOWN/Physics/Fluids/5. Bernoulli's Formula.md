...
> A significant insight is that **if the velocity of the fluid is zero ($v=0$), Bernoulli's formula simplifies to [Pascal's Law](2.%20Pascal's%20law.md)** ($P = P_0 + \rho g h$). This highlights that Pascal's Law is a specific case of Bernoulli's formula for fluids at rest.
