...
Now we construct another TM $D$, which can run $H$ and outputs the opposite of what $H$ outputs:

![[Pasted image 20250829135019.png]]

This TM $D$, upon input $⟨M⟩$, basically runs $M$ using the string encoding of $M$ (written $⟨M⟩$) as input, and outputs the opposite of the result of $M$.
...
![[Pasted image 20260112141906.png]]
