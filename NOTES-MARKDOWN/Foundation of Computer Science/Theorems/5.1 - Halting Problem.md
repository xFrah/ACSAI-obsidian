...
We want to show that if we had this TM R, then we necessarily can decide $A_{TM}$ too (which we [[4.11 - A_TM is undecidable|proved is undecidable]]). 

We do this by constructing a machine that can decide $A_{TM}$.
