Every question about [[3. Regular Languages|regular languages]] is decidable, we have to prove it.
...
### Membership in [[4. Regular Expressions|regular expressions]]
...
> [!warning] Important hint
> We actually need this! Because we can't compare infinite sets.
> Instead, we are just creating a new automata (with the closure properties), and checking for emptyness, which is actually decidable (theorem above).
