...
They are important because they are polynomially time related. If exists a polynomial time algorithm for solving one of these, then all of them will be polynomial time solvable (which means they are all in P).

### Polynomial time reducibility

Language A is polynomial time reducible to language B, if membership of A is equal to membership of B, after i apply the transformation function.
